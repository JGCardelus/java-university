...
public class Anciano extends Persona {
	...
	public final float FACTOR_RIESGO_DEFAULT = (float) 0.75;

	public Anciano(boolean contagiado, Persona[] contactos, int problemasRespiratorios, int problemasCardiacos, float factorRiesgo) {
