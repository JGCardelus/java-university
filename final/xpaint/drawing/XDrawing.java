...
public class XDrawing implements CanvasMouseEvents {
	public static final String EXTENSION = "xpt";
	...
	public void save(String filePath) {
		IODrawing iod = new IODrawing(this.getShapes());
		iod.save(filePath);
	}

	public void open(String filePath) {
		IODrawing iod = new IODrawing();
		this.setShapes(iod.open(filePath));
		this.xpaint.paint();
	}

	public void exportToCsv(String filePath) {
		IODrawing iod = new IODrawing(this.getShapes());
		iod.exportToCsv(filePath);
	}

	public void importFromCsv(String filePath) {
		IODrawing iod = new IODrawing();
		this.setShapes(iod.importFromCsv(filePath));
		this.xpaint.paint();
	}
